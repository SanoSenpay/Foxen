            ...
            <main class="fp-tools-content">
                <div class="fp-tools-page-content active" data-page="general">
                    ...
                    <div class="support-promo">
                        <span class="nav-icon" style="display:inline-flex;margin:0 6px 0 0;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg></span> Спасибо за использование этого <a href="https://addons.mozilla.org/ru/firefox/addon/funpay-tools-fork/" target="_blank">расширения</a>!</span>
                    </div>
                    ...
                    <label class="checkbox-label-inline"><input type="checkbox" id="fptIdentifierEnabled" checked><span>Показывать метку «FunPay Tools» рядом с ником собеседника</span></label>
                    ...
                    <div class="support-promo" style="background: rgba(255, 152, 0, 0.1); border-color: rgba(255, 152, 0, 0.3); margin-top: 15px;">
                        <span class="nav-icon" style="color: #ff9800;"><span class="nav-icon" style="display:inline-flex;margin:0 6px 0 0;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg></span></span>
