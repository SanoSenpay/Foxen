...
async function loadSavedSettings() {
    ...
    // Custom notification sound URL UI
    const customBlock = document.getElementById('notificationCustomSoundBlock');
    if (customBlock) customBlock.style.display = savedSound === 'custom' ? 'block' : 'none';
}