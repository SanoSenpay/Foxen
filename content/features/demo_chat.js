...
<div class="fpdm-review-box">
  ...
  <div class="fpdm-rev-actions">
    ...
    <div class="fpdm-chat-window" style="flex-direction: row; ${isSidebar ? 'width: 1000px;' : 'width: 800px;'}">
        ...
        msgs = []; state = 'idle';
        sys('👋 Добро пожаловать в Тестовый чат! Здесь вы можете протестировать функционал FunPay Tools, не затрагивая реальные заказы и чаты. <br><br>⚠️ Внимание: Этот чат всё ещё находится на стадии разработки, поэтому возможны некоторые неточности в работе.');
    }
